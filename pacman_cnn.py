...
#SBATCH -N 1
#SBATCH -p exclusive
#SBATCH -o tf_test_cnn_latest.out
#SBATCH -t 100:00:00
#SBATCH --gres=gpu:2
...
class Brain:
    ...
    def predictTest(self,s):
        self.loadModel('pacman-basic-cnn.h5')
...
for e in range(10000):
    ...
    print e,",",R
    if R > bestReward:
        agent.brain.model.save("pacman-basic-cnn_best.h5")
        bestReward = R

    if e%100==0:
	agent.brain.model.save("pacman-basic-cnn_latest.h5")
